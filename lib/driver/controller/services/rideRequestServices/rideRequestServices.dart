...
import 'package:katon_taxi25/common/controller/services/toastService.dart';
  ...
  static endRide(String rideID, BuildContext context) async {
    try {
      ...
      DatabaseReference rideRef = FirebaseDatabase.instance.ref().child(
        'RideRequest/$rideID/rideEndTime',
      );
      DatabaseReference rideRefFetchData = FirebaseDatabase.instance
          .ref()
          .child('RideRequest/$rideID');
      DatabaseReference riderRef = FirebaseDatabase.instance.ref().child(
        'RideHistoryRider/$rideID/$uniqueID',
      );
      ...
      DatabaseReference driverRef = FirebaseDatabase.instance.ref().child(
        'RideHistoryDriver/$rideID/$uniqueID',
      );
